...
//APPLICATION CLIENT
app.get('/application_client', routes.application_client);

//Application transporteur
app.get('/application_transporteur', routes.application_transporteur);

//Application simulateur
app.get('/application_simulateur', routes.application_simulateur);
//Mon CV
app.get('/mon_cv', routes.curriculum);
